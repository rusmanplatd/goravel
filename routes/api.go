...
func Api() {
	...
	facades.Route().Get("/api/v1/organizations/{id}/departments", departmentController.Index)
	facades.Route().Post("/api/v1/organizations/{id}/departments", departmentController.Store)
	facades.Route().Get("/api/v1/organizations/{id}/departments/{department_id}", departmentController.Show)
	facades.Route().Put("/api/v1/organizations/{id}/departments/{department_id}", departmentController.Update)
	facades.Route().Delete("/api/v1/organizations/{id}/departments/{department_id}", departmentController.Delete)
	facades.Route().Get("/api/v1/organizations/{id}/departments/{department_id}/users", departmentController.Users)
	facades.Route().Post("/api/v1/organizations/{id}/departments/{department_id}/users", departmentController.AddUser)
	facades.Route().Delete("/api/v1/organizations/{id}/departments/{department_id}/users/{user_id}", departmentController.RemoveUser)

	// Team management routes (protected) - temporarily without middleware for testing
	facades.Route().Get("/api/v1/organizations/{id}/teams", teamController.Index)
	facades.Route().Post("/api/v1/organizations/{id}/teams", teamController.Store)
	facades.Route().Get("/api/v1/organizations/{id}/teams/{team_id}", teamController.Show)
	facades.Route().Put("/api/v1/organizations/{id}/teams/{team_id}", teamController.Update)
	facades.Route().Delete("/api/v1/organizations/{id}/teams/{team_id}", teamController.Delete)
	facades.Route().Get("/api/v1/organizations/{id}/teams/{team_id}/users", teamController.Users)
	facades.Route().Post("/api/v1/organizations/{id}/teams/{team_id}/users", teamController.AddUser)
	facades.Route().Delete("/api/v1/organizations/{id}/teams/{team_id}/users/{user_id}", teamController.RemoveUser)

	// Project management routes (protected) - temporarily without middleware for testing
	facades.Route().Get("/api/v1/organizations/{id}/projects", projectController.Index)
	facades.Route().Post("/api/v1/organizations/{id}/projects", projectController.Store)
	facades.Route().Get("/api/v1/organizations/{id}/projects/{project_id}", projectController.Show)
	facades.Route().Put("/api/v1/organizations/{id}/projects/{project_id}", projectController.Update)
	facades.Route().Delete("/api/v1/organizations/{id}/projects/{project_id}", projectController.Delete)
	facades.Route().Get("/api/v1/organizations/{id}/projects/{project_id}/users", projectController.Users)
	facades.Route().Post("/api/v1/organizations/{id}/projects/{project_id}/users", projectController.AddUser)
	facades.Route().Delete("/api/v1/organizations/{id}/projects/{project_id}/users/{user_id}", projectController.RemoveUser)
	facades.Route().Get("/api/v1/organizations/{id}/projects/{project_id}/teams", projectController.Teams)
	facades.Route().Post("/api/v1/organizations/{id}/projects/{project_id}/teams", projectController.AddTeam)
	facades.Route().Delete("/api/v1/organizations/{id}/projects/{project_id}/teams/{team_id}", projectController.RemoveTeam)

	// Task management routes (protected) - temporarily without middleware for testing
	taskController := v1.NewTaskController()
	facades.Route().Get("/api/v1/organizations/{id}/projects/{project_id}/tasks", taskController.Index)
	facades.Route().Post("/api/v1/organizations/{id}/projects/{project_id}/tasks", taskController.Store)
	facades.Route().Get("/api/v1/organizations/{id}/projects/{project_id}/tasks/{task_id}", taskController.Show)
	facades.Route().Put("/api/v1/organizations/{id}/projects/{project_id}/tasks/{task_id}", taskController.Update)
	facades.Route().Delete("/api/v1/organizations/{id}/projects/{project_id}/tasks/{task_id}", taskController.Delete)
	facades.Route().Get("/api/v1/organizations/{id}/projects/{project_id}/task-labels", taskController.Labels)
	facades.Route().Post("/api/v1/organizations/{id}/projects/{project_id}/task-labels", taskController.CreateLabel)
	facades.Route().Get("/api/v1/organizations/{id}/projects/{project_id}/milestones", taskController.Milestones)
	facades.Route().Post("/api/v1/organizations/{id}/projects/{project_id}/milestones", taskController.CreateMilestone)
	facades.Route().Get("/api/v1/organizations/{id}/projects/{project_id}/task-boards", taskController.Boards)
	facades.Route().Post("/api/v1/organizations/{id}/projects/{project_id}/task-boards", taskController.CreateBoard)
