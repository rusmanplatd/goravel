...
echo "- OpenAPI 3.0 UI: http://localhost:8080/openapi.html"
echo "- OpenAPI 3.0 YAML: http://localhost:8080/docs/openapi.yaml"
echo "- OpenAPI 3.0 JSON: http://localhost:8080/docs/openapi.json" 