...
echo "- OpenAPI 3.0 UI: http://localhost:7000/openapi.html"
echo "- OpenAPI 3.0 YAML: http://localhost:7000/api/docs/openapi.yaml"
echo "- OpenAPI 3.0 JSON: http://localhost:7000/api/docs/openapi.json" 